...
public class PageVO {
	private int startNo; // 튜플 시작번호
	private int endNo;  //튜플 끝번호
	private int perPageNum=5; //페이지 총 개수
	private Integer page; //현재페이지           // Integer 웹에서 받은 페이지 정보(String)가 없으면 null인데 int는 null을 저장할 수 없다. 오류방지
